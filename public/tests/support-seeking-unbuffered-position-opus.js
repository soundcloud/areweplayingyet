({
  name: 'support-seeking-unbuffered-position-opus',
  description: 'Seeking to unbuffered position with continuous playback after seeking (Opus)',
  assert: function(finish) {
    ...
    audio.src = AWPY.sound.long.stream_url(false, 'opus');
  }
})
